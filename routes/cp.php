...
use AltDesign\AltCommerceStatamic\Http\Controllers\StockController;
...
Route::group(['middleware' => ['statamic.cp.authenticated']], function () {
    ...
    Route::get('alt-commerce/stock/{productId}', [StockController::class, 'show'])->name('alt-commerce::stock.show');
    Route::post('alt-commerce/stock/{productId}/adjust', [StockController::class, 'adjust'])->name('alt-commerce::stock.adjust');
